...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        const helpCommand = new Discord.MessageEmbed()
            ...
            .addField(`<:Untitled:871681364834000919> Leveling and Xp:`, `[\`lvl-settings\`](https://discord.gg/WHPSxcQkVk), [\`xp-settings\`](https://discord.gg/WHPSxcQkVk), [\`xp-reset\`](https://discord.gg/WHPSxcQkVk), [\`top-xp\`](https://discord.gg/WHPSxcQkVk), [\`xp\`](https://discord.gg/WHPSxcQkVk)`)
            .addField(`<a:coinsoneforall:823538178622488616> Giveaways:`, `[\`gstart\`](https://discord.gg/WHPSxcQkVk), [\`greroll\`](https://discord.gg/WHPSxcQkVk), [\`glist\`](https://discord.gg/WHPSxcQkVk), [\`gend\`](https://discord.gg/WHPSxcQkVk)`)
