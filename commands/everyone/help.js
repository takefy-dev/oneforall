...
module.exports = class Test extends Command{
  ...
  const lang = guildData.lang;
        ...
        const helpCommand = new Discord.MessageEmbed()
            ...
            .addField(`<:server:783422366230380565> Backup:`, `[\`backup create\`](https://discord.gg/WHPSxcQkVk), [\`backup delete\`](https://discord.gg/WHPSxcQkVk), [\`backup load\`](https://discord.gg/WHPSxcQkVk), [\`backup list\`](https://discord.gg/WHPSxcQkVk), [\`backup info\`](https://discord.gg/WHPSxcQkVk)`)
            .addField(`<:desc2:783422775821729792> Autres:`, `[\`counter\`](https://discord.gg/WHPSxcQkVk), [\`embed\`](https://discord.gg/WHPSxcQkVk), [\`reactrole\`](https://discord.gg/WHPSxcQkVk), [\`tempvoc\`](https://discord.gg/WHPSxcQkVk), [\`gstart\`](https://discord.gg/WHPSxcQkVk), [\`greroll\`](https://discord.gg/WHPSxcQkVk), [\`invite\`](https://discord.gg/WHPSxcQkVk), [\`addinvite\`](https://discord.gg/WHPSxcQkVk), [\`removeinvite\`](https://discord.gg/WHPSxcQkVk), [\`clearinvite\`](https://discord.gg/WHPSxcQkVk), [\`invite config\`](https://discord.gg/WHPSxcQkVk), [\`topinvite\`](https://discord.gg/WHPSxcQkVk)`)
